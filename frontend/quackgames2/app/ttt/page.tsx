  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        {/* Messages Container */}
        <div id="message-container" className="w-full max-w-3xl text-black bg-white border-2 p-4 rounded-lg">
        ...
        <div className="grid grid-cols-3 gap-4 mt-4">
          {buttonArray.map((buttonValue, index) => (
            <button
              ...
              className="w-12 h-12 bg-gray-200 border rounded text-black font-semibold"
            >
              {buttonValue}
            </button>
          ))}
        </div>
        <button onClick={resetButtonClick} id="reset-button" className="ml-2 bg-blue-500 px-4 py-2 rounded">
          Reset
        </button>
